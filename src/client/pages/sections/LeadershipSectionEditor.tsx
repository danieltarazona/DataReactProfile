                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="col-span-2">
                                        <label className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Organization (EN)</label>
                                        <input
                                            value={item.organizationEn || ''}
                                            onChange={(e) => sectHook.updateEntry(item.id, 'organizationEn', e.target.value)}
